...
handler.help = ['جبل', 'ببجي', 'جيمينج', 'أنمي', 'عشوائي', 'قهوة', 'سيارة', 'كرتون', 'فضاء إلكتروني', 'تكنولوجيا', 'درايمون', 'هكر', 'كوكب', 'ملف عشوائي', 'جماليات 2', 'مركبة', 'خلفية هاتف', 'دراجة نارية'];
handler.tags = ['صور'];
handler.command = ['جبل', 'ببجي', 'جيمينج', 'أنمي', 'عشوائي', 'قهوة', 'سيارة', 'كرتون', 'فضاء إلكتروني', 'تكنولوجيا', 'درايمون', 'هكر', 'كوكب', 'ملف عشوائي', 'جماليات 2', 'مركبة', 'خلفية هاتف', 'دراجة نارية'];
